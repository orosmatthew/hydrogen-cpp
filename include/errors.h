...
inline std::string caret_display(size_t pos, size_t width = 1, size_t offset = 0)
{
...
inline std::string caret_to_line(const std::string& str, size_t pos, size_t line = 1, size_t width = 1)
{
    std::stringstream output;
    size_t line_start = 0;
